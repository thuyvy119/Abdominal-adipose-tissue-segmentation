...
class myPlot():
    def __init__(self,
                saveDir = '/Users/vynguyen/Documents/VSCode/Abdominal_segmentation/plots',
                figsize = (8,6), origin_top_left = False, blockShow = True,
                overwrite_all = False
                ):
    ...
    def show_imgs(self, list_imgs, imageNames = None,
                main_title = None, figsize = None, colormap = 'inferno',
                vmax = None, vmin = None):
